...
//     // struct
//     // {
//     //     uint64_t EKK_REQ_COMP_SPEED : 8;        // EKK请求压缩机速度
//     //     uint64_t EKK_ENB_COMP : 2;              // EKK使能压缩机
//     //     uint64_t EKK_HV_ST : 2;                 // EKK高压开关状态
//     //     uint64_t EKK_KL_15_Status : 2;          // EKK KL15电平状态
//     //     uint64_t EKKe_Q_Mask : 1;               // EKKe Q掩码
//     //     uint64_t EKKe_Level_REQ : 1;            // EKKe请求电平
//     //     uint64_t EKKe_Error_Mask_Nr : 8;        // EKKe错误掩码号
//     //     uint64_t Reserved : 40;                 // 保留位
//     //     uint64_t EKK_REQ_COMP_SPEED_HiRes : 16; // EKK请求高分辨率压缩机速度
//     // } EKKe_01;
...
// {
//     /* data */
//     Subscribed_Data frame1;
//     uint8_t Frame_id;
//     uint8_t Send_Flag;
// } Subscribed_Frame;

// // 将参数中的 "struct Published_Frame* frame" 改为 "Published_Frame* frame"
// void init_Subscribed_Frame(Subscribed_Frame *frame, uint8_t Frame_id, uint64_t init_Data)
// {
//     frame->Frame_id = Frame_id;
//     frame->frame1.raw = init_Data;
// }

/***********************************Subscribed Frames End**********************************************/

/***********************************Published Frames Start**********************************************/
typedef union
{
    struct
    {
...
typedef struct
{
    Lin_Frame_Data frame1;
    uint8_t Frame_id;
    uint8_t Send_Flag;
} Frame;

// 将参数中的 "struct Published_Frame* frame" 改为 "Published_Frame* frame"
void init_Frame(Frame *frame, uint8_t Frame_id, uint64_t init_Data)
{
    frame->Frame_id = Frame_id;
    frame->frame1.raw = init_Data;
}
/***********************************Published Frames End**********************************************/
