...
#ifndef RTW_HEADER_Sub_CANDCDCsignalCal_h_
#define RTW_HEADER_Sub_CANDCDCsignalCal_h_
...
extern void DIM_model_Sub_CANDCDCsignalCal(void);

#endif                                 /* RTW_HEADER_Sub_CANDCDCsignalCal_h_ */
