...
#ifndef RTW_HEADER_TQM_h_
#define RTW_HEADER_TQM_h_
...
extern void TQM_model_TQM_Init(void);
extern void TQM_model_TQM_Start(void);
extern void TQM_model_TQM(void);

#endif                                 /* RTW_HEADER_TQM_h_ */
