...
#ifndef RTW_HEADER_Sub_CANOBCsignalCal_h_
#define RTW_HEADER_Sub_CANOBCsignalCal_h_
...
extern void DIM_model_Sub_CANOBCsignalCal(void);

#endif                                 /* RTW_HEADER_Sub_CANOBCsignalCal_h_ */
