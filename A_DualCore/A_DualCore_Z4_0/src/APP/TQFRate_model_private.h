...
#ifndef RTW_HEADER_TQFRate_model_private_h_
#define RTW_HEADER_TQFRate_model_private_h_
#include "rtwtypes.h"
#ifndef UCHAR_MAX
#include <limits.h>
#endif
...
extern uint8_T lib_TQFRate_look2_is16_rGX7Vq93(int16_T u0, int16_T u1, const
  int16_T bp0[], const int16_T bp1[], const uint8_T table[], const uint32_T
  maxIndex[], uint32_T stride);

#endif                                 /* RTW_HEADER_TQFRate_model_private_h_ */
