...
#ifndef RTW_HEADER_MCU_AntiShake_h_
#define RTW_HEADER_MCU_AntiShake_h_
...
extern void TQM_model_MCU_AntiShake(void);

#endif                                 /* RTW_HEADER_MCU_AntiShake_h_ */
