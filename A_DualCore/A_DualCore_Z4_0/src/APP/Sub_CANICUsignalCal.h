...
#ifndef RTW_HEADER_Sub_CANICUsignalCal_h_
#define RTW_HEADER_Sub_CANICUsignalCal_h_
...
extern void DIM_model_Sub_CANICUsignalCal(void);

#endif                                 /* RTW_HEADER_Sub_CANICUsignalCal_h_ */
