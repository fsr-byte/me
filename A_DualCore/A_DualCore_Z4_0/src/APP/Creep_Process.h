...
#ifndef RTW_HEADER_Creep_Process_h_
#define RTW_HEADER_Creep_Process_h_
...
extern void TQM_model_Creep_Process(void);

#endif                                 /* RTW_HEADER_Creep_Process_h_ */
