...
#ifndef RTW_HEADER_Sub_CANMCUsignalCal_h_
#define RTW_HEADER_Sub_CANMCUsignalCal_h_
...
extern void DIM_model_Sub_CANMCUsignalCal(void);

#endif                                 /* RTW_HEADER_Sub_CANMCUsignalCal_h_ */
