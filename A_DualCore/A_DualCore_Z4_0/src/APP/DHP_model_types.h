...
#ifndef RTW_HEADER_DHP_model_types_h_
#define RTW_HEADER_DHP_model_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_PEPS_ChallengeCode_
#define DEFINED_TYPEDEF_FOR_PEPS_ChallengeCode_

typedef struct {
  uint8_T VPEPS_ChallengeCode0_uint8;
  uint8_T VPEPS_ChallengeCode1_uint8;
  uint8_T VPEPS_ChallengeCode2_uint8;
  uint8_T VPEPS_ChallengeCode3_uint8;
  uint8_T VPEPS_ChallengeCode4_uint8;
  uint8_T VPEPS_ChallengeCode5_uint8;
  uint8_T VPEPS_ChallengeCode6_uint8;
  uint8_T VPEPS_ChallengeCode7_uint8;
} PEPS_ChallengeCode;

#endif

#ifndef DEFINED_TYPEDEF_FOR_PEPS_EnKey_
#define DEFINED_TYPEDEF_FOR_PEPS_EnKey_

typedef struct {
  uint8_T VPEPS_EnKey0_uint8;
  uint8_T VPEPS_EnKey1_uint8;
  uint8_T VPEPS_EnKey2_uint8;
  uint8_T VPEPS_EnKey3_uint8;
  uint8_T VPEPS_EnKey4_uint8;
  uint8_T VPEPS_EnKey5_uint8;
  uint8_T VPEPS_EnKey6_uint8;
  uint8_T VPEPS_EnKey7_uint8;
} PEPS_EnKey;

#endif

#ifndef DEFINED_TYPEDEF_FOR_PEPS_PEPS_
#define DEFINED_TYPEDEF_FOR_PEPS_PEPS_

typedef struct {
  uint8_T VPEPS_SendChallengeCodeType_enum;
  uint8_T VPEPS_Result_enum;
  PEPS_ChallengeCode VPEPS_ChallengeCode_array;
  PEPS_EnKey EnKey;
} PEPS_PEPS;
...
#ifndef DEFINED_TYPEDEF_FOR_BDHP_SnapShots_
#define DEFINED_TYPEDEF_FOR_BDHP_SnapShots_

typedef struct {
  uint16_T VDHP_TMTqReq;
  uint8_T VDHP_VehSts_enum;
  uint8_T VDHP_PEPS_PDU_enum;
  uint8_T VDHP_GearOut_enum;
  uint8_T VDHP_AccelPedal_per;
  uint8_T VDHP_BrkLightSwitchActive_flg;
  uint16_T VDHP_ABS_VehicleSpeed;
  uint8_T VDHP_LVBattVoltage_V;
  uint8_T VDHP_BMSChrgSts_enum;
  uint16_T VDHP_MotTqReal;
  uint8_T VDHP_MCUIGBTT;
  uint8_T VDHP_MCUElecMotT;
  uint16_T VDHP_MCUElecMotSpd;
  uint16_T VDHP_BMSSOC;
  uint16_T VDHP_BMSBattU;
  uint16_T VDHP_BMSBattI;
  uint8_T VDHP_BMSAvrgBattT;
  uint8_T VDHP_DCDCT;
  uint32_T VDHP_TotalVehDistance_km;
  uint8_T VDHP_FltTime_Year;
  uint8_T VDHP_FltTime_Month;
  uint8_T VDHP_FltTime_Day;
  uint8_T VDHP_FltTime_Hour;
  uint8_T VDHP_FltTime_Minute;
  uint8_T VDHP_FltTime_Second;
  uint16_T VDHP_BMSErrNum;
  uint8_T VDHP_MCUErrNum;
  uint8_T VDHP_BrkLightSwitch;
  uint8_T VDHP_GearSwitch;
  uint16_T VDHP_AccelPedalH_kv;
  uint16_T VDHP_AccelPedalL_kv;
  uint16_T VDHP_WaterPWM_Duty;
  uint16_T VDHP_VacuumPump_HZ;
  uint16_T VDHP_SRSPWM_Duty;
  uint16_T VDHP_SRSPWM_HZ;
  uint16_T VDHP_HVInterlock_HZ;
  uint8_T VDHP_HLspdFan;
  uint8_T VDHP_WaterPump_flg;
  uint8_T VDHP_EPB_Status;
  uint8_T VDHP_EPBAppliedReq;
  uint8_T VDHP_FastChargeAwake_flg;
  uint8_T VDHP_SlowChargeAwake_flg;
  uint8_T VDHP_MainRelay_flg;
  uint8_T VDHP_gbWhoWriteCalArea;
} BDHP_SnapShots;

#endif
#endif                                 /* RTW_HEADER_DHP_model_types_h_ */
