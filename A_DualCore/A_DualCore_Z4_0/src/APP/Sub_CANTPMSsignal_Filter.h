/*
 * File: Sub_CANTPMSsignal_Filter.h
 *
...
#define RTW_HEADER_Sub_CANTPMSsignal_Filter_h_
...
extern void DIM_model_Sub_CANTPMSsignal_Filter(void);

#endif                                 /* RTW_HEADER_Sub_CANTPMSsignal_Filter_h_ */
