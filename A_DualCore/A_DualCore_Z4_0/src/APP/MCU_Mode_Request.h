...
#ifndef RTW_HEADER_MCU_Mode_Request_h_
#define RTW_HEADER_MCU_Mode_Request_h_
...
extern void TQM_model_MCU_Mode_Request(void);

#endif                                 /* RTW_HEADER_MCU_Mode_Request_h_ */
