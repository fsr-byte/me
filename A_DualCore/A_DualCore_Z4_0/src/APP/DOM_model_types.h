...
#ifndef DEFINED_TYPEDEF_FOR_AVAS_
#define DEFINED_TYPEDEF_FOR_AVAS_

typedef struct {
  uint8_T AVAS_LowSpdWarnEna;
} AVAS;
...
#ifndef DEFINED_TYPEDEF_FOR_DIP_
#define DEFINED_TYPEDEF_FOR_DIP_

typedef struct {
  real32_T VDIP_VCUPwrCnse_KW;
  boolean_T VDIP_VCUPwrSysFlt_flg;
  boolean_T VDIP_PwrBattCutOff_flg;
  uint8_T DIP_TextDisplayer_enum;
  uint8_T DIP_VCUBattChrgStatus;
} DIP;
