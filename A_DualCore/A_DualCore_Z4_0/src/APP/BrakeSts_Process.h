...
#ifndef RTW_HEADER_BrakeSts_Process_h_
#define RTW_HEADER_BrakeSts_Process_h_
...
extern void TQM_model_BrakeSts_Process(void);

#endif                                 /* RTW_HEADER_BrakeSts_Process_h_ */
