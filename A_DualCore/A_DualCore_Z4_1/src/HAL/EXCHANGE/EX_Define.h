...
#define EX_TS   1   //当UDS和NVM移植到Core0后将该宏定义置为1
...
#define Exchange_Input_Addr	Exchange_C0T1_Addr	//----不同核时需要改变
#define Exchange_Output_Addr	Exchange_C1T0_Addr	//----不同核时需要改变
...
#define Core0ID		(1)
#define Core1ID		(2)
#define MyCore		Core1ID		//----不同核时需要改变
...
#define Gate_Input	Gate_C0T1	//----不同核时需要改变
#define Gate_Output	Gate_C1T0	//----不同核时需要改变
...
//Software Interrupt
__EX_DEFINE_EXTERN__ void Set_SI0(void);
