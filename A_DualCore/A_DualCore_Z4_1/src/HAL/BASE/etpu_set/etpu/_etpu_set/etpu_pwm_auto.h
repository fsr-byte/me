...
#define FS_ETPU_PWM_NUM_PARMS 0x18
...
#define FS_ETPU_PWM_PERIOD_OFFSET 0x1
#define FS_ETPU_PWM_ACTIVE_OFFSET 0x5
#define FS_ETPU_PWM_CO_PERIOD_OFFSET 0x9
#define FS_ETPU_PWM_CO_ACTIVE_OFFSET 0xd
