...
(uint32_t) &dummy, /* Vector #   0 Software settable flag  0 INTC_SSCIR0[CLR0] */
...
(uint32_t) &INT_ENET_TX_ISR, /* Vector # 218 Ethernet_0_0 EIR[TXF] */
(uint32_t) &INT_ENET_RX_ISR, /* Vector # 219 Ethernet_0_1 EIR[RXF] */
...
(uint32_t) &INT_PIT0_1_ISR, /* Vector # 227 Periodic Interrupt Timer (PIT1) PIT_1_TFLG1[TIF] */
...
(uint32_t) &INT_RT_ISR, /* Vector # 239 PIT_RTI PIT_0_RTI_TFLG[TIF] */
...
(uint32_t) &INT_CAN0_RX_ISR, /* Vector # 679 FlexCAN_0_5 CAN0_IFRL[BUF7:BUF0] */
(uint32_t) &INT_CAN0_RX_ISR, /* Vector # 680 FlexCAN_0_2 CAN0_IFRL[BUF15:BUF8] */
...
(uint32_t) &INT_CAN1_RX_ISR, /* Vector # 685 FlexCAN_1_5 CAN1_IFRL[BUF7:BUF0] */
...
(uint32_t) &INT_CAN2_RX_ISR, /* Vector # 691 FlexCAN_2_5 CAN2_IFRL[BUF7:BUF0] */
...
(uint32_t) &INT_CAN3_RX_ISR, /* Vector # 697 FlexCAN_3_5 CAN3_IFRL[BUF7:BUF0] */
(uint32_t) &INT_CAN3_RX_ISR, /* Vector # 698 FlexCAN_3_2 CAN3_IFRL[BUF15:BUF8] */
(uint32_t) &INT_CAN3_RX_ISR, /* Vector # 699 FlexCAN_3_3 CAN3_IFRL[BUF31:BUF16] */
(uint32_t) &INT_CAN3_RX_ISR, /* Vector # 700 FlexCAN_3_4 CAN3_IFRL[BUF63:BUF32] */
...
(uint32_t) &INT_eMIOS0_8_ISR, /* Vector # 706 eMIOS_0 channel 8 EMIOS_0_GFR[F8] */
(uint32_t) &dummy, /* Vector # 707 eMIOS_0 channel 9 EMIOS_0_GFR[F9] */
(uint32_t) &dummy, /* Vector # 708 eMIOS_0 channel 10 EMIOS_0_GFR[F10] */
(uint32_t) &INT_eMIOS0_11_ISR, /* Vector # 709 eMIOS_0 channel 11 EMIOS_0_GFR[F11] */
(uint32_t) &dummy, /* Vector # 710 eMIOS_0 channel 12 EMIOS_0_GFR[F12] */
(uint32_t) &INT_eMIOS0_13_ISR, /* Vector # 711 eMIOS_0 channel 13 EMIOS_0_GFR[F13] */
(uint32_t) &INT_eMIOS0_14_ISR, /* Vector # 712 eMIOS_0 channel 14 EMIOS_0_GFR[F14] */
(uint32_t) &INT_eMIOS0_15_ISR, /* Vector # 713 eMIOS_0 channel 15 EMIOS_0_GFR[F15] */
(uint32_t) &INT_eMIOS0_16_ISR, /* Vector # 714 eMIOS_0 channel 16 EMIOS_0_GFR[F16] */
(uint32_t) &INT_eMIOS0_17_ISR, /* Vector # 715 eMIOS_0 channel 17 EMIOS_0_GFR[F17] */
(uint32_t) &dummy, /* Vector # 716 eMIOS_0 channel 18 EMIOS_0_GFR[F18] */
(uint32_t) &INT_eMIOS0_19_ISR, /* Vector # 717 eMIOS_0 channel 19 EMIOS_0_GFR[F19] */
(uint32_t) &INT_eMIOS0_20_ISR, /* Vector # 718 eMIOS_0 channel 20 EMIOS_0_GFR[F20] */
(uint32_t) &INT_eMIOS0_21_ISR, /* Vector # 719 eMIOS_0 channel 21 EMIOS_0_GFR[F21] */
(uint32_t) &INT_eMIOS0_22_ISR, /* Vector # 720 eMIOS_0 channel 22 EMIOS_0_GFR[F22] */
(uint32_t) &dummy, /* Vector # 721 eMIOS_0 channel 23 EMIOS_0_GFR[F23] */
(uint32_t) &INT_eMIOS1_8_ISR, /* Vector # 722 eMIOS_1 channel 8 EMIOS_1_GFR[F8] */
(uint32_t) &INT_eMIOS1_9_ISR, /* Vector # 723 eMIOS_1 channel 9 EMIOS_1_GFR[F9] */
(uint32_t) &INT_eMIOS1_10_ISR, /* Vector # 724 eMIOS_1 channel 10 EMIOS_1_GFR[F10] */
(uint32_t) &INT_eMIOS1_11_ISR, /* Vector # 725 eMIOS_1 channel 11 EMIOS_1_GFR[F11] */
(uint32_t) &INT_eMIOS1_12_ISR, /* Vector # 726 eMIOS_1 channel 12 EMIOS_1_GFR[F12] */
(uint32_t) &dummy, /* Vector # 727 eMIOS_1 channel 13 EMIOS_1_GFR[F13] */
(uint32_t) &INT_eMIOS1_14_ISR, /* Vector # 728 eMIOS_1 channel 14 EMIOS_1_GFR[F14] */
(uint32_t) &INT_eMIOS1_15_ISR, /* Vector # 729 eMIOS_1 channel 15 EMIOS_1_GFR[F15] */
...
(uint32_t) &INT_eMIOS1_19_ISR, /* Vector # 733 eMIOS_1 channel 19 EMIOS_1_GFR[F19] */
(uint32_t) &dummy, /* Vector # 734 eMIOS_1 channel 20 EMIOS_1_GFR[F20] */
(uint32_t) &INT_eMIOS1_21_ISR, /* Vector # 735 eMIOS_1 channel 21 EMIOS_1_GFR[F21] */
(uint32_t) &INT_eMIOS1_22_ISR, /* Vector # 736 eMIOS_1 channel 22 EMIOS_1_GFR[F22] */
